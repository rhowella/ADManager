...
namespace ActiveDirManager.API.App_Start
{
  /// <summary>
  ...
  public static class AutofacConfig
  {
    ...
    public static void Configure(HttpConfiguration configuration)
    {
      ...
      builder.RegisterType<AssociateRepository>().As<IAssociateRepository>();
      builder.RegisterType<ImportManager>().As<IImportManager>();
